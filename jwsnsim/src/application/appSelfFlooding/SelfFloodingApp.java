...
public class SelfFloodingApp extends Application implements TimerHandler{
	...
	public SelfFloodingApp(int numNodes,String logFile,int topology) throws Exception {
