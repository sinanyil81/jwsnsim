...
public class LogicalClock {
	...
	public AdaptiveValueTracker rate = new StandardAdaptiveValueTrackerFactory().newAdaptiveValueTracker(-250.0, 250.0,0.0,0.00000001,false);   		
	...
	public UInt32 getValue(UInt32 currentTime){
		...
		int progress = timePassed + (int)(((float)timePassed)*rate.getCurrentValue());
