...
public class SelfMessage9 {
	...
	public SelfMessage9(int nodeid, Register32 clock, Register32 offset, int sequence) {
		this.nodeid = nodeid;
	...
	public SelfMessage9(int nodeid, Register32 clock, Register32 offset,Register32 hardwareClock,float rateMultiplier,int sequence) {
		this.nodeid = nodeid;
		this.clock = new Register32(clock);
		this.offset = new Register32(offset);
